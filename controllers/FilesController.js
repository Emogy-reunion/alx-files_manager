...
/**
 * Validates if a given ID is a valid ObjectId format.
...
export default class FilesController {
  ...
  static async postUpload(req, res) {
    ...
    if (type === VALID_FILE_TYPES.image) {
      const jobName = `Image thumbnail [${userId}-${insertedId}]`;
      fileQueue.add({ userId, fileId: insertedId.toString(), name: jobName });
    }
    res.status(201).json({
  ...
  /**
   * Publishes a file, making it accessible to everyone.
   * @param {Request} req - The Express request object.
   * @param {Response} res - The Express response object.
   */
  ...
  /**
   * Unpublishes a file, restricting its access.
   * @param {Request} req - The Express request object.
   * @param {Response} res - The Express response object.
   */
  ...
  /**
   * Retrieves and serves the content of a file.
   * @param {Request} req - The Express request object.
   * @param {Response} res - The Express response object.
   */
